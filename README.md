J'ai repris et me suis basé sur la class Fraction de la dernière version de mon TP07 [ici](https://github.com/MaximeMalpica/TP07/blob/main/TP07.py).

Concernant le TP09, j'ai effectué une modification au TP07 qui est de rajouter pydoc. Le fichier contenant les tests est intitulé test_unitaire.py.

J'ai aussi ajouter la librairie coverage afin d'avoir le test coverage qui permet d'analyser quelle quantité de code a été tester par nos tests. Concernant mon code, j'obtient une moyenne de 63% pour les 2 fichiers python, le pourcentage manquant sont du à la partie du programme qui est dans le "if main" qui s'exécute seulement si on lance spécifiquement le fichier lui-même.
...
Vous pouvez aussi constater que j'ai effectué plusieurs commit via l'outils GitHub Desktop et donc j'aimerais valider la compétence Projet-4.
